...
if __name__ == '__main__':
    ...
    parser.add_argument('mode',
                        ...
                        default='dummy',
                        help='Run mode. \'dummy\' will send an emtpy buffer to the server to benchmark the server for 10 seconds. \'image\' will process an image. \'video\' will process a video.')
    ...
    if FLAGS.mode == 'dummy':
        ...
        print("Invoking inference for benchmark...")
        t_end = time.time() + FLAGS.benchmark_timeout
        fps_time = time.time()
        ...
        while time.time() < t_end:
            ...
            if time.time() - fps_time >= 1:
                print("FPS: ", str(1/inference_time))
                fps_time = time.time()
